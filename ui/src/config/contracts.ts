...
export const PAYROLL_CONTRACT = {
  ...
  {
    "inputs": [],
    "name": "PayrollEmployeeAddressZero",
    "type": "error"
  },
  {
    "inputs": [
    ...
    "name": "PayrollEmployeeNotRegistered",
    "type": "error"
  },
  {
    "anonymous": false,
...
export function isConfigured(address: string) {
